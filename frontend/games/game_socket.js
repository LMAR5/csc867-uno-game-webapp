...
const configure = (gameSocketId) => {
  ...
  gameSocket.on(
    GAME_AFTER_PLAY,
    ({ source, discardCard, gameHands, currentTurn, gameId, playerId }) => {
      console.log({
        event: GAME_AFTER_PLAY,
        source,
        discardCard,
        gameHands,
        currentTurn,
